...
| As a delegate, when hosting a carnival and logged in, from the carnival page I want to be able to see the player lists of all the clubs attending my carnival, so I can keep track of attendance, including name, dob and shorts colour. One full list showing player name, club, dob and shorts colour would be very useful. | ⭕ Not Started |
