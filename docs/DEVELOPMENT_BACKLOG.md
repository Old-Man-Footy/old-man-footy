...
| As a user, under the "Carnivals Hosted by" section on /clubs/:id page, I want to see a "Carnivals Attended by" card. Showing which carnivals that club are registered to attend. | ⭕ Not Started |
