...
describe('AlternateNamesManager', () => {
    ...
    describe('Add Name', () => {
        it('should send a POST request and reload on successful submission', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith('/clubs/edit/alternate-names', expect.objectContaining({
                method: 'POST',
    ...
    describe('Delete Name', () => {
        ...
        it('should send a DELETE request and reload if confirmed', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith('/clubs/edit/alternate-names/2', { method: 'DELETE' });
            expect(mockLocation.reload).toHaveBeenCalled();
        });
    });
    ...
    describe('Edit Name', () => {
        ...
        it('should send a PUT request and reload on successful edit submission', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith('/clubs/edit/alternate-names/1', expect.objectContaining({
                method: 'PUT',
