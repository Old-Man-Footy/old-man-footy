...
export const addressUtilsManager = {
  elements: {},

  /**
   * Initialize the Address Utils Manager
   * Cache DOM elements and bind events if needed in the future
   */
  initialize() {
    this.cacheElements();
    this.bindEvents();
    console.log('Address Utils Manager initialized');
  },
   ...
   */
  cacheElements() {
    // Cache DOM elements if needed in the future
  },
   ...
   */
  formatCarnivalAddress(carnival) {
   ...
   */
  getGoogleMapsUrl(carnival) {
    const addressData = this.formatCarnivalAddress(carnival);
   ...
   */
  hasLocationData(carnival) {
    return this.formatCarnivalAddress(carnival) !== null;
  }
};

document.addEventListener('DOMContentLoaded', () => {
  addressUtilsManager.initialize();
});
